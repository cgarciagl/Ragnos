...
- **`selector`** (string): jQuery selector (e.g. `'#my_detail_table'`) where the HTML content will be injected.
...
- **`selector`** (string): jQuery selector where the report will be injected.
