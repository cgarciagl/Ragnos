...
if (!function_exists('_oldRecordCache')) {
    /**
...
if (!function_exists('setOldRecordCache')) {
...
if (!function_exists('fieldHasChanged')) {
...
if (!function_exists('importModelFromController')) {
    /**
...
if (!function_exists('mapClassToURL')) {
    /**
...
if (!function_exists('controllerNameToURL')) {
